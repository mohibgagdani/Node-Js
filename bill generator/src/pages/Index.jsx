...
const Index = () => {
  ...
  const handleTemplateClick = (templateNumber) => {
    if (!customerEmail) {
      setSelectedTemplateForEmail(templateNumber);
  ...
  const handleEmailSubmit = (email) => {
    ...
    if (selectedTemplateForEmail) {
      ...
      navigate("/template", {
        state: { formData, selectedTemplate: selectedTemplateForEmail },
      });
      ...
      <div className="flex flex-col md:flex-row gap-8">
        <div className="w-full md:w-1/2 bg-white p-6 rounded-lg shadow-md">
          <form>
            ...
            <div className="mb-6">
              <h3 className="text-lg font-medium mb-2">Customer Email</h3>
              ...
              <p className="text-sm text-gray-600 mt-1">
                Email is required to generate and send invoices
              </p>
            </div>
